    ...
    return (
        <div className="container py-5">
            ...
            <p className="text-center text-muted mb-5">
                As enchentes devastam comunidades inteiras, deixando famílias desabrigadas e sem recursos.
                Sua doação é essencial para levar alimentos, roupas e abrigo a quem mais precisa.
            </p>
