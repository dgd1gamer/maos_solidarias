export default function Deslizamentos() {
    return (
        <div className="container py-5">
            <h1 className="text-3xl fw-bold text-center text-primary mb-4">
                Ajude as Vítimas dos Deslizamentos
            </h1>

            <p className="text-center text-muted mb-5">
                Os deslizamentos de terra causam perdas humanas e materiais incalculáveis.
                Com sua ajuda, podemos garantir abrigo, alimento e suporte às famílias afetadas.
            </p>
