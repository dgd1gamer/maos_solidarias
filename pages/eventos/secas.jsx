export default function Secas() {
    return (
        <div className="container py-5">
            <h1 className="text-3xl fw-bold text-center text-primary mb-4">
                Ajude as Vítimas das Secas
            </h1>

            <p className="text-center text-muted mb-5">
                As secas afetam milhares de famílias em todo o país. Sua doação ajuda a levar
                água, alimentos e esperança a quem mais precisa.
            </p>
